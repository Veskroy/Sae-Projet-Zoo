 ...
 */
final class Version20240109150015 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, name_event VARCHAR(30) DEFAULT NULL, date_event DATETIME DEFAULT NULL, h_start_event DATETIME DEFAULT NULL, h_end_event DATETIME DEFAULT NULL, max_nb_places INT DEFAULT NULL, desc_event VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE pen (id INT AUTO_INCREMENT NOT NULL, capacity INT DEFAULT NULL, type VARCHAR(50) DEFAULT NULL, size DOUBLE PRECISION DEFAULT NULL, num_place INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
